...
var genValue = function genValue(value, dateFormatter, proColumnsMap) {
  var tmpValue = {};
    ...
    if (itemValue && itemValue !== 'all') {
      if (_moment.default.isMoment(itemValue) && dateFormatter) {
        if (dateFormatter === 'string') {
          var formatString = dateFormatterMap[(proColumnsMap[key || 'null'] || {}).valueType || 'dateTime'];
...
var FormSearch = function FormSearch(_ref3) {
  ...
  var submit = function submit() {
    ...
    if (onSubmit) {
      onSubmit(genValue(value, dateFormatter, proColumnsMap));
    }
  };
  ...
  return _react.default.createElement(_configProvider.ConfigConsumer, null, function (_ref4) {
    ...
    }, collapse ? 'Open' : 'Collapse', ' ', _react.default.createElement(_icons.DownOutlined, {
      style: {
        transition: '0.3s all',
