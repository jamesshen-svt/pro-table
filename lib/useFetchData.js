...
var useFetchData = function useFetchData(getData, defaultData, options) {
  ...
  var _useState5 = (0, _react.useState)(defaultCurrent || 1),
  ...
  var _useState11 = (0, _react.useState)(false),
      ...
      setHasMore = _useState12[1]; // pre state


  var prePage = usePrevious(pageIndex);
  var prePageSize = usePrevious(pageSize);
